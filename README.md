...
|---|---|---|---|
| [**External Events**](external-events/) | How synvert xgeeks builds brand, talent and business through external events: an always-on community meetup engine (~500K pipeline), geekathon, KCD Porto, and individual recognition on national stages. | 19 slides · Marketing briefing 2026 | [deck](https://fabiosampaio-91.github.io/xgeeks-presentations/external-events/) · [analysis](https://fabiosampaio-91.github.io/xgeeks-presentations/external-events/analysis.html) |
...
| [**CJR · Plano de Discovery**](cjr-discovery/) | Plano de Discovery de 2 semanas para o procurement da CJR Renewables: estrutura das semanas, agenda presencial, stakeholders e anexos (one-pager PDF e email ao cliente). | Plano web + anexos · CJR Renewables | [plan](https://fabiosampaio-91.github.io/xgeeks-presentations/cjr-discovery/) |
