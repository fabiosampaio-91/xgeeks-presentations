...
|---|---|---|---|
| [**External Events**](external-events/) | How synvert xgeeks builds brand, talent and business through external events: an always-on community meetup engine (~500K pipeline), geekathon, KCD Porto, and individual recognition on national stages. | 16 slides · Marketing briefing 2026 | [deck](https://fabiosampaio-91.github.io/xgeeks-presentations/external-events/) · [analysis](https://fabiosampaio-91.github.io/xgeeks-presentations/external-events/analysis.html) |
